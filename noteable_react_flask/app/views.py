...
def addarticle():
    ...
    print(article)
    try:
        # replace with Lyra's add Article function 
        #database.insertArticle(self, user=", articleTitle=", articleIcon=", articleBlurb=", articleAuthor=", articleDate=", articleURL=article, tags="")
